...
public interface UnicornConst {
    ...
    public static final int UC_MODE_REAL = 16;
    public static final int UC_MODE_PROTECTED = 32;
    public static final int UC_MODE_LONG = 64;
    public static final int UC_MODE_VIRTUAL = 128;
